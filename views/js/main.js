...
var resizePizzas = function(size) {
  ...
  //all chagePizzaSizes does is figure out which width it wants, then sets that
  //to pixel width in the below for loop, for randomPizzas, not .movers
...
//put .randomPizzaContainer DOM nodes in randomPizzas variable (determineDx
//accessed these several times within a for loop)
  ...
  /*function changePizzaSizes(size) {
    var randomPizzas = document.quereSelectorAll(".randomPizzaContainer");
    for (var i = 0; i < randomPizzas.length; i++) {
...
//this is triggering layout thrashing - how do i get rid of thrashing?
//move the calculation which utilizes scrollTop method outside the loop
//.scrollTop sets number of pixels and element's content is scrolled vertically
//this controls the moving pizzas
//mod 5 operator sets 5 different values for the phase - returns integer -
//whatever the value of i, i%5 is always a value from 0 to 4 - so calculating the
//phase values inside
//the main loop is a waste of resources
//add will-change:transform and transform:translateZ(0) to .mover in css,
//and limit .movers to 24
...
//add updatePositions funciton as parameter to window.requestAnimationFrame - optimizes animations into single relow and repaint cycle
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  //there are 8 columns and 3 visible rows. Can I get away with
  //24 pizzas instead of 200? yes
  for (var i = 0; i < 24; i++) {
    var elem = document.createElement('img');
    elem.className = 'mover';
    elem.src = "images/pizza.png";
    //why not resize pizza.png instead of asking browser to do it? - well, when
    //I removed height and width below the sliding pizzas became huge, and neither
    //resizing pizzapng file to 100x100 or adding size or background-size to
    //mover css shrunk movers
